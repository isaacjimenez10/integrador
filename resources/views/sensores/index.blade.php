...
<head>
    ...
    <style>
        ...
        * {
        ...
        #sensorChart {
            width: 100% !important;
            height: 500px !important; /* Aumentado de 200px a 500px */
        }
...
<body>
    ...
    <script>
        ...
        function updateChart() {
            ...
            // Si la gráfica ya existe, destruirla antes de crear una nueva
            if (sensorChart) {
                sensorChart.destroy();
            }
        ...
        // Actualizar gráfica al cargar la página
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Actualizar gráfica al enviar el formulario de búsqueda
