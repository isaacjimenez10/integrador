...
<head>
    ...
    <title>Dashboard Cliente - Invernadero</title>
    <style>
        body {
...
<body>
    <div class="dashboard-container">
        ...
        <div class="user-info">
            <h2>Bienvenido, <strong>{{ Auth::guard('cliente')->user()->nombre }}</strong></h2>
            <p>Este es tu panel de cliente. Aquí puedes gestionar tu cuenta y acceder a las funcionalidades disponibles.</p>
            <p>Email: <strong>{{ Auth::guard('cliente')->user()->email }}</strong></p>
            <p>Estado: <strong>{{ Auth::guard('cliente')->user()->bloqueado ? 'Bloqueado' : 'Activo' }}</strong></p>
        </div>

        <div class="quick-links">
            <a href="{{ route('cliente.perfil') }}">Mi Perfil</a>
            <a href="{{ route('cliente.configuracion') }}">Configuración</a>
        </div>
