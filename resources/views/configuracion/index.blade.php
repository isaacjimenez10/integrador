...
<body>
    ...
    <div class="container">
        ...
        <div class="pagination">
            ...
            <span>
                Mostrando {{ $configuraciones->firstItem() }} a {{ $configuraciones->lastItem() }} de {{ $configuraciones->total() }} resultados
            </span>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            searchForm.addEventListener('submit', (e) => {
                ...
                .then(html => {
                    ...
                    const newTable = doc.querySelector('#configTable');
                    document.getElementById('configTable').replaceWith(newTable);
